...
# The bot
bot = commands.Bot(prefix, intents = intents, case_insensitive = True, test_guilds=[991449832474554428, 793633014662823993], sync_commands_debug= True, sync_commands=True)
...
async def status_task():
    while True:
        await bot.change_presence(activity=disnake.Activity(type=disnake.ActivityType.watching,
                name=f'/help | Estou em {len(bot.guilds)} servidores'),status=disnake.Status.online)
